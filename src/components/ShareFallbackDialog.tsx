      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="font-heading font-bold text-foreground text-lg">Share</h3>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Share grid */}
        <div>
          <p className="text-muted-foreground text-xs font-semibold uppercase tracking-wider mb-3">Share using</p>
          <div className="grid grid-cols-4 gap-4">
            {allItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-transform group-hover:scale-110 group-active:scale-95 shadow-lg ${iconData?.bg || "bg-primary"}`}>
